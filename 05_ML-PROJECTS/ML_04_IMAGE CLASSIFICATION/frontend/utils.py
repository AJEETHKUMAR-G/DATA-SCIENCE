...
def classify_image(image_base64_data,file_path= None):
    ...
    for img in imgs:
        ...
        combined_img = np.vstack((scaled_img.reshape(32*32*3,1),scaled_har_img.reshape(32*32,1)))
...
def get_b64_image_for_virat():
    with open('federer.txt') as f:
        return f.read()

# Use this 'https://www.base64-image.de/' to get base64 encode images


if __name__ == '__main__':
    load_saved_artifacts()
    #print(classify_image(get_b64_image_for_virat(),None))
    #print(class_number_to_name())
